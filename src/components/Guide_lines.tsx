    ...
    <div className='guideline' style={{padding: '120px'}}>   
      ...
      <ol className='guideDesc'>
        {guidelines.map((guide, index) => (
          <li key={index}>
            <div className="guideTitle">{guide.title}:</div> <span className="guideDescription">{guide.description}</span>
          </li>
        ))}
      </ol>
    </div>
